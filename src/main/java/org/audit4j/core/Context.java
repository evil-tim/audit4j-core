...
public final class Context {
    ...
    /**
     * Initialize the Audit4j instance. This will ensure the single audit4j instance
     * and single Configuration repository load in to the memory.
     */
     ...
     *
     * This method allows to external plugins can inject the configurations. Since
     * the security reasons, this allows to create one time configuration setting to
     * Audit4j.
     *
     ...
     *
     * @param configFilePath the new config file path
     */
